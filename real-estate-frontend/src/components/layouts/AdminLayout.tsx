    ...
    },
    {
        ...
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 018.25 20.25H6A2.25 2.25 0 013.75 18v-2.25z" />
    ...
    return (
        ...
        >
            ...
            <div className={`flex items-center h-16 px-5 border-b border-gray-800/80 ${!sidebarExpanded ? 'justify-center' : ''}`}>
                <Link to="/admin" className="text-white font-bold text-lg tracking-tight">
                        ...
                        <div key={nav.name}>
                            {nav.subItems ? (
                                <button
                                    ...
                                    className={`flex items-center w-full gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors ${openSubmenu === index
                                ...
                                >
                                    ...
                                    {sidebarExpanded && (
                                        <>
                                            ...
                                            <ChevronDownIcon
                                                className={`w-4 h-4 transition-transform duration-200 ${openSubmenu === index ? 'rotate-180' : ''
                                                    }`}
                                            />
                                        </>
                                    )}
                                ...
                                <button
                                    ...
                                    className={`flex items-center w-full gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-colors ${isActive(nav.path!)
                                    ...
                                    <div className="mt-1 ml-8 space-y-0.5">
                                        {nav.subItems.map((sub) => (
                                            <button
                                                ...
                                                className={`block w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${isActive(sub.path)
    ...
    return (
        <header className="sticky top-0 z-[9999] flex items-center justify-between h-16 px-4 lg:px-6 bg-white/80 backdrop-blur-xl border-b border-gray-200 shadow-theme-xs">
            ...
            <div className="relative">
                ...
                <Dropdown isOpen={userDropdownOpen} onClose={() => setUserDropdownOpen(false)} className="w-52">
                    <div className="py-1">
                        <DropdownItem onClick={() => { navigate('/admin/profile'); setUserDropdownOpen(false); }}>
                        ...
                        <DropdownItem onClick={() => { navigate('/'); setUserDropdownOpen(false); }}>
                            <span className="flex items-center gap-2">
                                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
